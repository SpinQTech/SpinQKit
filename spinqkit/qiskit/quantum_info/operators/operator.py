...
from spinqkit.qiskit.circuit.library.standard_gates import IGate, XGate, YGate, ZGate, HGate, SGate, TGate
from spinqkit.qiskit.exceptions import QiskitError
from spinqkit.qiskit.quantum_info.operators.predicates import is_unitary_matrix, matrix_equal
...
class Operator(LinearOp):
    ...
    def to_instruction(self):
        ...
        from spinqkit.qiskit.extensions.unitary import UnitaryGate
