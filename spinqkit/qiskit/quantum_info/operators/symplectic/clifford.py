...
from spinqkit.qiskit.circuit.library.standard_gates import IGate, XGate, YGate, ZGate, HGate, SGate
from spinqkit.qiskit.quantum_info.operators.base_operator import BaseOperator
...
from spinqkit.qiskit.quantum_info.synthesis.clifford_decompose import decompose_clifford
from spinqkit.qiskit.quantum_info.operators.mixins import generate_apidocs, AdjointMixin
...
class Clifford(BaseOperator, AdjointMixin):
    ...
    * Rows *N* to *2N-1* are the *stabilizer* group generators.
    ...
    .. jupyter-execute::
        ...
        from spinqkit.qiskit.quantum_info import Clifford
