...
from spinqkit.qiskit.quantum_info.operators.channel.transformations import _to_superop
from spinqkit.qiskit.quantum_info.operators.channel.transformations import _bipartite_tensor
...
class SuperOp(QuantumChannel):
    ...
    *(column-vectorization)*.
    ...
    def _evolve(self, state, qargs=None):
        ...
        from spinqkit.qiskit.quantum_info.states.densitymatrix import DensityMatrix
