...
from spinqkit.qiskit.dagcircuit.exceptions import DAGCircuitError
from spinqkit.qiskit.dagcircuit.dagnode import DAGNode
from spinqkit.qiskit.exceptions import MissingOptionalLibraryError
...
class DAGCircuit:
    ...
    def reverse_ops(self):
        ...
        from spinqkit.qiskit.converters import dag_to_circuit, circuit_to_dag
    ...
    def draw(self, scale=0.7, filename=None, style="color"):
        ...
        Returns:
            ...
            otherwise None.
        """
        from spinqkit.qiskit.visualization.dag_visualization import dag_drawer
