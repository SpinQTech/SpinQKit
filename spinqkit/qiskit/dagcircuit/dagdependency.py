...
from spinqkit.qiskit.dagcircuit.exceptions import DAGDependencyError
from spinqkit.qiskit.dagcircuit.dagdepnode import DAGDepNode
from spinqkit.qiskit.quantum_info.operators import Operator
...
class DAGDependency:
    ...
    **Reference:**
    ...
    def global_phase(self, angle):
        ...
        """
        from spinqkit.qiskit.circuit.parameterexpression import ParameterExpression  # needed?
