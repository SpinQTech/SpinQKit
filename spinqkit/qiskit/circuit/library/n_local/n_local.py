...
from spinqkit.qiskit.circuit import Instruction, Parameter, ParameterVector, ParameterExpression
from spinqkit.qiskit.circuit.parametertable import ParameterTable
...
class NLocal(BlueprintCircuit):
    ...
    def __str__(self) -> str:
        ...
        """
        from spinqkit.qiskit.compiler import transpile
