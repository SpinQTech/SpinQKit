...
import numpy
from spinqkit.qiskit.circuit import QuantumCircuit, QuantumRegister, AncillaRegister
# from spinqkit.qiskit.quantum_info import Statevector, Operator, DensityMatrix
...
class GroverOperator(QuantumCircuit):
    ...
    Examples:
        ...
        >>> from spinqkit.qiskit.circuit.library import GroverOperator
    ...
    def __init__(
        ...
        #     from spinqkit.qiskit.circuit.library import Diagonal  # pylint: disable=cyclic-import
