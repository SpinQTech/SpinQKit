...
import numpy as np
from spinqkit.qiskit.quantum_info.random import random_unitary
from spinqkit.qiskit.circuit import QuantumCircuit
from spinqkit.qiskit.circuit.library.generalized_gates.permutation import Permutation
...
class QuantumVolume(QuantumCircuit):
    ...
    **Reference Circuit:**
    ...
    .. jupyter-execute::
        ...
        from spinqkit.qiskit.circuit.library import QuantumVolume
