...
from spinqkit.qiskit.circuit import ControlledGate, Gate, Instruction, Qubit, QuantumRegister, QuantumCircuit
...
class MCMTVChain(MCMT):
    ...
    **Expanded Circuit:**
    ...
    .. jupyter-execute::
        ...
        from spinqkit.qiskit.circuit.library import MCMTVChain, ZGate
    ...
    **Examples:**
        ...
        >>> from spinqkit.qiskit.circuit.library import HGate
