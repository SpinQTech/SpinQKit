...
from spinqkit.qiskit.circuit import Parameter, ParameterVector, QuantumRegister, QuantumCircuit
...
class EvolvedOperatorAnsatz(BlueprintCircuit):
    ...
    def __init__(
        ...
        if evolution is None:
            ...
            from spinqkit.qiskit.opflow import PauliTrotterEvolution
    ...
    def _build(self):
        ...
        from spinqkit.qiskit.opflow import PauliOp
