...
from spinqkit.qiskit.circuit import QuantumRegister, QuantumCircuit
from spinqkit.qiskit.circuit.library.standard_gates import MCXGate
...
class AND(QuantumCircuit):
    ...
    .. jupyter-execute::
        ...
        from spinqkit.qiskit.circuit.library import AND
