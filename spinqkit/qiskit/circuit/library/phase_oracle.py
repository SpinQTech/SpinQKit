...
from spinqkit.qiskit.circuit.classicalfunction.boolean_expression import BooleanExpression
from spinqkit.qiskit.circuit.classicalfunction.classical_element import ClassicalElement
    ...
    def __init__(
        ...
        if synthesizer is None:
            ...
            def synthesizer(boolean_expression):
                ...
                from spinqkit.qiskit.circuit.classicalfunction.utils import tweedledum2qiskit
