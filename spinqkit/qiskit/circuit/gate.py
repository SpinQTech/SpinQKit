...
class Gate(Instruction):
    ...
    def power(self, exponent: float):
        ...
        """
        from spinqkit.qiskit.quantum_info.operators import Operator  # pylint: disable=cyclic-import
        from spinqkit.qiskit.extensions.unitary import UnitaryGate  # pylint: disable=cyclic-import
