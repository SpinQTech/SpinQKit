...
from spinqkit.qiskit.extensions import UnitaryGate
...
def control(
    ...
    import spinqkit.qiskit.circuit.controlledgate as controlledgate
    ...
    if operation.name == "x" or (
        ...
        for gate, qargs, _ in definition.data:
            if gate.name == "x":
                ...
                from spinqkit.qiskit.circuit.library import MCPhaseGate
