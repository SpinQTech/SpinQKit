...
from spinqkit.qiskit.circuit.quantumregister import QuantumRegister
from spinqkit.qiskit.circuit.classicalregister import ClassicalRegister, Clbit
# from spinqkit.qiskit.qobj.qasm_qobj import QasmQobjInstruction
from spinqkit.qiskit.circuit.parameter import ParameterExpression
...
class Instruction:
    ...
    def decompositions(self):
        ...
        from spinqkit.qiskit.circuit.equivalence_library import SessionEquivalenceLibrary as sel
    ...
    def inverse(self):
        ...
        from spinqkit.qiskit.circuit import QuantumCircuit, Gate  # pylint: disable=cyclic-import
