...
import numpy as np
from spinqkit.qiskit.exceptions import QiskitError, MissingOptionalLibraryError
from spinqkit.qiskit.utils.multiprocessing import is_main_process
from spinqkit.qiskit.circuit.instruction import Instruction
from spinqkit.qiskit.circuit.gate import Gate
from spinqkit.qiskit.circuit.parameter import Parameter
# from spinqkit.qiskit.qasm.qasm import Qasm
# from spinqkit.qiskit.qasm.exceptions import QasmError
from spinqkit.qiskit.circuit.exceptions import CircuitError
from spinqkit.qiskit.utils.deprecation import deprecate_function, deprecate_arguments
...
try:
    ...
    # from spinqkit.qiskit.qasm.pygments import OpenQASMLexer  # pylint: disable=ungrouped-imports
    # from spinqkit.qiskit.qasm.pygments import QasmTerminalStyle  # pylint: disable=ungrouped-imports
...
class QuantumCircuit:
    ...
    def __eq__(self, other):
        ...
        from spinqkit.qiskit.converters import circuit_to_dag
    ...
    def compose(self, other, qubits=None, clbits=None, front=False, inplace=False):
        ...
        for instr, qargs, cargs in instrs:
            ...
            if instr.condition is not None:
                from spinqkit.qiskit.dagcircuit import DAGCircuit  # pylint: disable=cyclic-import
    ...
    def to_instruction(self, parameter_map=None):
        ...
        """
        from spinqkit.qiskit.converters.circuit_to_instruction import circuit_to_instruction
    ...
    def to_gate(self, parameter_map=None, label=None):
        ...
        Returns:
            ...
            (can be decomposed back)
        """
        from spinqkit.qiskit.converters.circuit_to_gate import circuit_to_gate
    ...
    def decompose(self):
        ...
        from spinqkit.qiskit.transpiler.passes.basis.decompose import Decompose
        from spinqkit.qiskit.converters.circuit_to_dag import circuit_to_dag
        from spinqkit.qiskit.converters.dag_to_circuit import dag_to_circuit
    ...
    #     """
    #     from spinqkit.qiskit.circuit.controlledgate import ControlledGate
    #
    #     if self.num_parameters > 0:
        ...
        **latex_source**: raw uncompiled latex output.
        ...
        Example:
            .. jupyter-execute::
                ...
                from qiskit import QuantumRegister, ClassicalRegister, QuantumCircuit
                from spinqkit.qiskit.tools.visualization import circuit_drawer
                q = QuantumRegister(1)
        ...
        # pylint: disable=cyclic-import
        from spinqkit.qiskit.visualization import circuit_drawer
    ...
    def remove_final_measurements(self, inplace=True):
        ...
        """
        # pylint: disable=cyclic-import
        from spinqkit.qiskit.transpiler.passes import RemoveFinalMeasurements
        from spinqkit.qiskit.converters import circuit_to_dag
    ...
    def assign_parameters(
        ...
        Examples:
            ...
            .. jupyter-execute::
                ...
                from spinqkit.qiskit.circuit import QuantumCircuit, Parameter
            ...
            .. jupyter-execute::
                ...
                from spinqkit.qiskit.circuit import QuantumCircuit, ParameterVector
    ...
    def pauli(self, pauli_string, qubits):
        ...
        from spinqkit.qiskit.circuit.library.generalized_gates.pauli import PauliGate
...
#     # pylint: disable=cyclic-import
#     from spinqkit.qiskit.converters import ast_to_dag
#     from spinqkit.qiskit.converters import dag_to_circuit
#
#     ast = qasm.parse()
#     dag = ast_to_dag(ast)
