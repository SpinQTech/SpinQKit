...
from spinqkit.model.instruction import Instruction
from typing import List
from math import pi
from spinqkit.model import Gate, InverseBuilder, Instruction
from spinqkit.model import RepeatBuilder, MultiControlPhaseGateBuilder
from spinqkit.model import H, X, Z
...
class AmplitudeAmplification(object):
    ...
    def build(self) -> List[Instruction]:
        ...
        if len(self.__reflection_qubits) == 1:
            ...
            mcz_builder = MultiControlPhaseGateBuilder(len(self.__reflection_qubits) - 1)
            inst_list.append(Instruction(mcz_builder.to_gate(), self.__reflection_qubits, [], pi))
