...
from spinqkit.backend import get_spinq_cloud
from spinqkit.model import Circuit
from spinqkit import H, CZ
...
if gemini.available():
    ...
    newTask = backend.submit_task("gemini_vp", ir, "spinqkittask1")
