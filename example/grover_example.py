...
from spinqkit import AmplitudeAmplification, GateBuilder, RepeatBuilder
from spinqkit import MultiControlPhaseGateBuilder, H, X
from math import pi
...
mcz_builder = MultiControlPhaseGateBuilder(3)
oracle_builder.append(mcz_builder.to_gate(), list(range(4)), pi)
oracle_builder.append(X, [2])
oracle_builder.append(X, [3])
