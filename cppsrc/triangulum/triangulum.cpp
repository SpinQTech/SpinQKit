...
set<int> Triangulum::decompose(const igraph_t* g)
{
    set<int> backbone;
...
void Triangulum::expand_caller(const igraph_t *g, const char *gate_name, igraph_vector_t *qubits, igraph_vector_t *params, 
